                                            ...
                                            <select class="form-control <?= session('errors.role_id') ? 'is-invalid' : '' ?>"
                                                ...
                                                <?php foreach ($roles as $role): ?>
                                                    <option value="<?= $role['id'] ?>"
                                                        ...
                                                        <?= esc($role['role_label']) ?> - <?= esc($role['role_description']) ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
...
$(document).ready(function() {
    ...
    $('#role_id').on('change', function() {
        ...
        if (selectedRole) {
            let roleHtml = `
                ...
                <p class="text-muted small mb-3">${selectedRole.role_description}</p>
                <div class="mb-2">
    ...
    function loadRecentInvitations() {
        ...
        const mockInvitations = [
            { email: 'john@example.com', role: 'Viewer', date: '2024-01-15', status: 'Sent' },
            { email: 'jane@example.com', role: 'Owner', date: '2024-01-10', status: 'Accepted' }
        ];
